...
public class AdvancedCalculator extends AppCompatActivity {
    ...
    private static Button sinButton,cosButton,tanButton,lnButton,logButton;
    private static Button x2Button,xyButton,percentButton,sqrtButton;
    ...
    public void setX2Button(){
        x2Button = findViewById(R.id.x2Button);
        x2Button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(!text.isEmpty() && checkSymbols(text)){
                    ...
                    num = num.pow(2,new MathContext(8));
    ...
    public void setXyButton(){
        xyButton = findViewById(R.id.xyButton);
    ...
    public void setLnButton(){
        lnButton = findViewById(R.id.lnButton);
        lnButton.setOnClickListener(v -> {
            String text = screen.getText().toString();
            if(!text.isEmpty() && (calculateSymbols(text) == 0||text.charAt(0)=='-')){
                BigDecimal num = BigDecimal.valueOf(Double.parseDouble(text));
                Double epsilon = 0.000001d;
                if((num.subtract(BigDecimal.valueOf(epsilon))).doubleValue() > 0){
                    Double val = Math.log(num.doubleValue());
                    screen.setText(val.toString());
                }
                else{
                    Context context = getApplicationContext();
        ...
        sinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!text.isEmpty() && (calculateSymbols(text) == 0||text.charAt(0)=='-')){
                    ...
                    num = Math.sin(Math.toRadians(num.doubleValue()));
                    screen.setText(num.toString());
                }
                else{
                    Context context = getApplicationContext();
                    CharSequence sequence = "Invalid operation";
        ...
        cosButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(!text.isEmpty() && (calculateSymbols(text) == 0||text.charAt(0)=='-')){
                    ...
                    num = Math.cos(Math.toRadians(num.doubleValue()));
                    screen.setText(num.toString());
                }
                else{
                    Context context = getApplicationContext();
    ...
    public void setTanButton(){
        ...
        tanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!text.isEmpty() && (calculateSymbols(text) == 0||text.charAt(0)=='-')){
                    Double num = Double.parseDouble(text);
                    num = Math.tan(Math.toRadians(num.doubleValue()));
                    screen.setText(num.toString());
                }
                else{
                    Context context = getApplicationContext();
    ...
    public void setSqrtButton(){
        sqrtButton = findViewById(R.id.sqrtButton);
        sqrtButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String text = screen.getText().toString();
                if(!text.isEmpty() && calculateSymbols(text) == 0 ){
